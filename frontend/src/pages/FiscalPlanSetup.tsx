...
export default function FiscalPlanSetup() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Create Fiscal Year Plan</h1>
      ...
      {step === 2 && (
        <div className="bg-white border border-gray-200 rounded-lg p-6 space-y-6">
          <div>
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Define Core Priorities</h2>
            <p className="text-gray-600 text-sm">
              ...
              <div key={index} className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="flex-1 space-y-3">
                    <div>
                      <label className="block text-sm font-medium text-gray-700 mb-2">
                        Priority Title {index === 0 && <span className="text-red-500">*</span>}
                      </label>
                      <input
                        type="text"
